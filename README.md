...
<fgpf данных для этого проекта содержит 4 таблицы. ![image](https://github.com/makc120264/ksd/assets/17950142/5b1eb397-0670-4e47-b93a-41b6f40bb9c2)

3) Написати скрипт на PHP який виводить на екран у вигляді таблиці ім'я співробітника та кількість проектів, в яких він бере участь, у порядку зростання кількості.
4) Виділити непарні рядки таблиці якимось кольором.
